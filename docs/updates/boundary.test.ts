...
describe('checkBoundary', () => {
  it('excludes node_modules', () => {
    const result = checkBoundary('/home/r3v/Stable/node_modules/lodash/index.ts');
  ...
  it('includes .ts files in src', () => {
    const result = checkBoundary('/home/r3v/Stable/packages/llpte-core/src/index.ts');
    expect(result.inScope).toBe(true);
  });

  it('includes .tsx files', () => {
    const result = checkBoundary('/home/r3v/Stable/client/src/components/DAW.tsx');
    expect(result.inScope).toBe(true);
  });
...
describe('isSkillFile', () => {
  it('identifies SKILL.md', () => {
    expect(isSkillFile('/home/r3v/Stable/packages/llpte-core/SKILL.md')).toBe(true);
  });

  it('rejects SKILL.md inside node_modules', () => {
    expect(isSkillFile('/home/r3v/Stable/node_modules/pkg/SKILL.md')).toBe(false);
  });

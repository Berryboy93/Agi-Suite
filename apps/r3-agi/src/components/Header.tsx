  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span>TSC</span>
          <span style={{ color: "var(--bad)", fontWeight: 700 }}>15 ERR</span>
        </div>
        <div
          style={{
            display: "flex",
        ...
        >
          <span>ROUTERS</span>
          <span style={{ color: "var(--done)", fontWeight: 700 }}>11/11</span>
        </div>
        <div
          style={{
            display: "flex",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
            ...
            <span
              style={{
                ...
                fontSize: 11,
                fontWeight: 700,
                color: connected ? "#a3e635" : "var(--text2)",
              }}
            >
              {metrics.activeUsers}
            </span>

#!/usr/bin/env bash
#==============================================================================
# Agi-Suite — Full Stack Master Script v10
# Rock-solid: portable grep, no , no -P dependencies, triple-checked
#==============================================================================
...
# ── Port / Process Utilities (Portable — No , No -P) ─────────────────────
get_port_pids() {
  local port="$1"
  # Use awk instead of grep  to avoid regex portability issues
